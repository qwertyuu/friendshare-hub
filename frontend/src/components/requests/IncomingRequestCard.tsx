...
import { User, Calendar, MessageCircle, Check, X, CheckCircle } from "lucide-react";
    ...
    <Card className="p-4 space-y-4">
      ...
      {request.responseMessage && (
        <div className="bg-blue-50 dark:bg-blue-900/10 rounded p-2 text-sm border border-blue-200 dark:border-blue-900/30">
          <p className="font-semibold text-blue-900 dark:text-blue-400 text-xs mb-1">Votre réponse</p>
